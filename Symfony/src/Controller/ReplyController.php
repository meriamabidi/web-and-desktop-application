...
class ReplyController extends AbstractController
{
    ...
    public function new(Request $request, ReplyRepository $replyRepository): Response
    {
        $reply = new Reply();
    ...
    public function edit(Request $request, Reply $reply, ReplyRepository $replyRepository): Response
    {
        $form = $this->createForm(ReplyType::class, $reply);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, Reply $reply, ReplyRepository $replyRepository): Response
    {
